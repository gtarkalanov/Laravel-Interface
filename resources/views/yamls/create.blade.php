        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('yamls.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('base_url') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="base_url" type="url" class="form-control" name="base_url" value="{{ old('base_url') }}" required>
